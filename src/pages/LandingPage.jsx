...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-transparent flex flex-col">
      <header className="px-4 md:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0 z-10 relative">
        <div className="flex items-center gap-3 text-primary font-bold text-2xl tracking-tight">
          <ShieldCheck className="h-10 w-10 text-primary" />
          ScamShield
        </div>
        <div className="flex flex-wrap justify-center gap-2 sm:gap-4">
          <Button variant="ghost" className="text-foreground hidden md:inline-flex">About</Button>
          <Button variant="ghost" className="text-foreground hidden md:inline-flex">Technology</Button>
      ...
      <main className="flex-1 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="container px-4 md:px-8 grid lg:grid-cols-2 gap-12 items-center z-10 py-8 md:py-0">
          <div className="space-y-8 max-w-2xl text-center lg:text-left mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
              <Button size="lg" onClick={() => navigate('/login')} className="w-full sm:w-auto text-base h-14 px-8 shadow-xl shadow-primary/20">
                Enter Security Console
              </Button>
              <Button size="lg" variant="outline" className="w-full sm:w-auto text-base h-14 px-8 gap-2" onClick={() => navigate('/transactions')}>
          ...
          <div className="h-[300px] sm:h-[400px] md:h-[600px] rounded-2xl border bg-card/50 backdrop-blur-sm shadow-2xl shadow-primary/5 flex items-center justify-center relative overflow-hidden mt-8 lg:mt-0">
             <IntelligenceSphere />
          </div>
        </div>
      </main>
